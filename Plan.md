...
2. В базе данных
   2.1 В таблице payment_entity появилась запись со статусом APPROVED 
...
**Шаг 4.** Заполнить все оставшиеся поля карты верно и нажать Продолжить. <br/>
**ОР.**
1. Появляется всплывающее уведомление с заголовком - Ошибка! и текстом - Банк отказал в проведение операции
2. В базе данных
   2.1 В таблице payment_entity появилась запись со статусом DECLINED
   2.2 В таблице order_entity появилась запись в столбце payment_id запись из столбца transaction_id таблицы payment_entity
...
1. Появляется всплывающее уведомление с заголовком - Успешно и текстом - Операция одобрена банком
2. В базе данных
   2.1 В таблице credit_request_entity появилась запись со статусом APPROVED
...
**ОР.**
1. Появляется всплывающее уведомление с заголовком - Ошибка! и текстом - Банк отказал в проведение операции
2. В базе данных -  появилась запись со статусом 
   2.1 В таблице credit_request_entity появилась запись со статусом DECLINED
   2.2 В таблице order_entity появилась запись в столбце credit_id запись из столбца bank_id таблицы credit_request_entity

### Сценарий 30. Купить в кредит. Неверная карта. 16 цифр, карта не существует
